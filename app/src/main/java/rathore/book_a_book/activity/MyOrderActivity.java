    ...
    private void fetchValues() {
        ...
        userCart.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Links.cancelDialog();
                adapter = new CartListingAdapter(MyOrderActivity.this,R.layout.listitemcart,array);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.submitAll){
            ...
            ref.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                @Override
                public void onCancelled(DatabaseError databaseError) {
                    Toast.makeText(MyOrderActivity.this, "Network Error!!! Enter New Address.", Toast.LENGTH_SHORT).show();
                    back.setVisibility(View.GONE);
                    label.setVisibility(View.GONE);
                    newBack.setVisibility(View.VISIBLE);
                    dialog.setContentView(view);
